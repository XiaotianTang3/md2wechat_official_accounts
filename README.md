...
- **报刊（v2 新增）**：编辑感版式。暖米白纸张底、墨黑正文、克制黄铜强调色、细线分节。适合长文、随笔、设计、商业分析。
...
- **燕麦·烟草·酒红（v2）**：Loro Piana / Bottega 单色系统。生活方式、文化随笔。
- **石色·鼠尾草·黄铜（v2）**：Aesop / Margaret Howell。设计、产品、文化深度长文。
...
v2 起新增「报刊」主题，并配套了四套编辑感配色（象牙·墨黑·黄铜 / 燕麦·烟草·酒红 / 石色·鼠尾草·黄铜 / 和纸·墨·朱赤），只在该主题下出现。旧的四个主题与六套配色保持不变，可继续使用，也可与「报刊」混搭。
