...
Use it to test previews, WeChat paste fidelity, and mobile preview behavior across different themes and palettes. Detailed checklist: [docs/manual-validation-checklist.md](docs/manual-validation-checklist.md).
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for project scope, the PR checklist, and manual validation expectations.
